        ...
        public void addToPack(T collection, Object o) {
            if (collection != null) {
                if (o != null) {
                    ...
                    throw new NullPointerException("Object being added to Collection<" + implClass.getName() + "> is null");
                }
            } else {
                throw new NullPointerException("Collection<" + implClass.getName() + "> is null");
            }
        }
